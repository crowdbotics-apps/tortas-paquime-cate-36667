...
## Project Structure
    ...
    ├── tortas_paquime_cate_36667  # Django project configurations
...
1. Clone this repo and `cd tortas_paquime_cate_36667`
...
2. Clone this repo and `cd tortas_paquime_cate_36667`
